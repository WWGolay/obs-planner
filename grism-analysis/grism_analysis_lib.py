...
import numpy as np; import ccdproc as ccdp
from astropy.io.fits import getdata; from scipy.ndimage.interpolation import rotate
...
class grism_analysis:
    def __init__(self, grism_image, cal_file,subimage_box=[0,0,0,0],ywidth=30):
        ''' Utilities for calibrating and plotting spectra from grism images'''
        
        self.grism_image = grism_image
        self.cal_file = cal_file
        self.balmer = np.array([397.0075, 410.1734, 434.0472, 486.135, 656.279])
    ...
    def wave_params(self):
        return self.jd, self.wave, self.calibrated_spectrum
    ...
    def plot_rectified_spectrum(self,T,wavemin=385,wavemax=700):
        ...
        ax3.plot(wave,spec_norm/base_fit,'r-')
